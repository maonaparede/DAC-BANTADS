...
export class RegisterComponent {
    ...
    if (this.registerForm.valid)
      try {
        const user: IUserAutocadastro = {
          ...
          telefone: this.registerForm.value.phone.replace(/\D/g, '') || '',
          salario:  this.removeNonNumericCharacters(this.registerForm.value.salary) || 0,
          cep: this.registerForm.value.cep || '',
          numero: this.removeNonNumericCharacters(this.registerForm.value.number) || 0,
          estado: this.state || '',
          cidade: this.city || '',
  ...
  private removeNonNumericCharacters(str : any) : Number {
